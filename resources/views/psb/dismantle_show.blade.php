                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('psb_dismantle_add_progress', $getDismantle->id) }}"
                                        class="btn btn-info btn-sm mb-2">
                                        <i class="fa fa-plus"></i> Add Progress
                                    </a>

                                    <a href="{{ route('psb.dismantle.print', $getDismantle->id) }}"
                                        class="btn btn-info btn-sm mb-2">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <!-- Tombol Kembali -->
                                    <a href="{{ route('psb.dismantle') }}" class="btn btn-sm btn-info mt-2">
