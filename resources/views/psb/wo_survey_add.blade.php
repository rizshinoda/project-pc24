        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <form action="{{ route('psb_survey_add_progress', $getSurvey->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            <a href="{{ route('psb.survey_show', $getSurvey->id) }}" class="btn btn-info"><i class="fa fa-arrow-left"></i> Kembali</a>
                            ...
                            <button type="submit" name="action" value="complete" class="btn btn-success pull-right">Selesaikan Proses Survey</button>
                        </div>
                    </form>
                </div>
