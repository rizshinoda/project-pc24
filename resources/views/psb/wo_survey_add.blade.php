                ...
                <div class="content-wrapper">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-6"> <!-- Lebar form setengah halaman -->
                            <div class="card">
                                <div class="card-body">
                                    <a href="{{ route('psb.survey_show', $getSurvey->id) }}" class="btn btn-sm btn-info"> <i class="fa fa-arrow-left"></i></a>
                                    ...
                                    <form action="{{ route('psb_survey_add_progress', $getSurvey->id) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group text-center">
                                            ...
                                            <button type="submit" name="action" value="complete" class="btn btn-success ">Selesaikan Proses Survey</button>
                                        </div>
                                    </form>
                                </div>
