                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('psb_relokasi_add_progress', $getRelokasi->id) }}"
                                        class="btn btn-info btn-sm mb-2">
                                        <i class="fa fa-plus"></i> Add Progress
                                    </a>

                                    <a href="{{ route('psb.relokasi.print', $getRelokasi->id) }}"
                                        class="btn btn-info btn-sm mb-2">
                                    ...
                                    <!-- Tombol Kembali -->
                                    <a href="{{ route('psb.relokasi') }}" class="btn btn-sm btn-info mt-2">
