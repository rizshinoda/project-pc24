                ...
                <div class="content-wrapper">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-6"> <!-- Lebar form setengah halaman -->
                            <div class="card">
                                <div class="card-body">
                                    <a href="{{ route('psb.maintenance_show', $getMaintenance->id) }}" class="btn btn-sm btn-info"> <i class="fa fa-arrow-left"></i></a>

                                    <h4 class="mb-5 text-center">Update Progress Maintenance</h4>
                                    {{-- Form untuk mengupload multiple foto --}}
                                    <form action="{{ route('psb_maintenance_add_progress', $getMaintenance->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
