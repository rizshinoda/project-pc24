                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('psb.downgrade.approve', $getDowngrade->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        <button type="button" class="btn btn-sm btn-success" onclick="confirmApproval('{{ route('psb.downgrade.approve', $getDowngrade->id) }}')">
                                    ...
                                    @if ($getDowngrade->status === 'On Progress' || $getDowngrade->status === 'Shipped' || $getDowngrade->status === 'Completed')
                                    <a href="{{ route('psb_downgrade_add_progress', $getDowngrade->id) }}"
                                        class="btn btn-info btn-sm mb-2">
                                        <i class="fa fa-plus"></i> Add Progress
                                    </a>

                                    <a href="{{ route('psb.downgrade.print', $getDowngrade->id) }}"
                                        class="btn btn-info btn-sm mb-2">
                                    ...
                                    <!-- Tombol Kembali -->
                                    <a href="{{ route('psb.downgrade') }}" class="btn btn-sm btn-info mt-2">
