                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('psb.survey.approve', $getSurvey->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        <button type="button" class="btn btn-success btn-sm mb-2" onclick="confirmApproval('{{ route('psb.survey.approve', $getSurvey->id) }}')">
                                    ...
                                    @if ($getSurvey->status === 'On Progress' || $getSurvey->status === 'Shipped' || $getSurvey->status === 'Completed')
                                    <a href="{{ route('psb_survey_add_progress', $getSurvey->id) }}"
                                        class="btn btn-info btn-sm mb-2">
                                        <i class="fa fa-plus"></i> Add Progress
                                    </a>

                                    <a href="{{ route('psb.survey.print', $getSurvey->id) }}"
                                        class="btn btn-info btn-sm mb-2">
                                    ...
                                    <a href="{{ route('psb.survey') }}" class="btn btn-info btn-sm mt-2 "><i class="fa fa-arrow-left"></i> Kembali</a>
