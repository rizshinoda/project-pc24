                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('psb_install_add_progress', $getInstall->id) }}" class="btn btn-info mb-3">
                                        Add Progress</a>
                                    <a href="{{ route('psb.instalasi.print', $getInstall->id) }}" class="btn btn-info pull-right mb-3">Cetak SPK</a>
                                    ...
                                    <a href="{{ route('psb.instalasi') }}" class="btn btn-info mt-3"><i class="fa fa-arrow-left"></i> Kembali</a>
