                ...
                <div class="content-wrapper">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-6"> <!-- Lebar form setengah halaman -->
                            <div class="card">
                                <div class="card-body">
                                    <a href="{{ route('psb.jasa_show', $getInstall->id) }}" class="btn btn-sm btn-info"> <i class="fa fa-arrow-left"></i></a>

                                    <h4 class="mb-5 text-center">Update Progress Jasa</h4>
                                    {{-- Form untuk mengupload multiple foto --}}
                                    <form action="{{ route('psb_jasa_add_progress', $getInstall->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
