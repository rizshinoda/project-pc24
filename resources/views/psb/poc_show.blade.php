                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <!-- Tombol Approve -->
                                    <form action="{{ route('psb.poc.approve', $getInstall->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        <button type="button" class="btn btn-success" onclick="confirmApproval('{{ route('psb.poc.approve', $getInstall->id) }}')">
                                    ...
                                    @endif
                                    <h4 class="card-title mt-2">Progres POC</h4>
                                    @if ($getInstall->status === 'On Progress' || $getInstall->status === 'Completed' || $getInstall->status === 'Shipped')
                                    <a href="{{ route('psb_poc_add_progress', $getInstall->id) }}" class="btn btn-info mb-3">
                                        Add Progress</a>
                                    <a href="{{ route('psb.poc.print', $getInstall->id) }}" class="btn btn-info pull-right mb-3">Cetak SPK</a>
                                    ...
                                    <!-- Tombol Kembali -->
                                    <a href="{{ route('psb.poc') }}" class="btn btn-info mt-3">
