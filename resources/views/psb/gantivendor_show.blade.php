                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('psb_gantivendor_add_progress', $getGantivendor->id) }}" class="btn btn-sm btn-info mb-3"><i class="fa fa-plus"></i>
                                        Add Progress</a>
                                    <a href="{{ route('psb.gantivendor.print', $getGantivendor->id) }}" class="btn btn-sm btn-info mb-3"><i class="fa fa-print"></i>Cetak SPK</a>
                                    ...
                                    <!-- Tombol Kembali -->
                                    <a href="{{ route('psb.gantivendor') }}" class="btn btn-sm btn-info mt-2">
