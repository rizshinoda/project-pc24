                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('psb.upgrade.approve', $getUpgrade->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        <button type="button" class="btn btn-success" onclick="confirmApproval('{{ route('psb.upgrade.approve', $getUpgrade->id) }}')">
                                    ...
                                    <a href="{{ route('psb_upgrade_add_progress', $getUpgrade->id) }}" class="btn btn-info mb-3">
                                        Add Progress</a>
                                    <a href="{{ route('psb.upgrade.print', $getUpgrade->id) }}" class="btn btn-info pull-right mb-3">Cetak SPK</a>
                                    ...
                                    <!-- Tombol Kembali -->
                                    <a href="{{ route('psb.upgrade') }}" class="btn btn-info mt-3">
