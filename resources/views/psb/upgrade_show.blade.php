                        ...
                        <div class="col">
                            <div class="card h-100">
                                <div class="card-body">
                                    ...
                                    <p><strong>Tanggal RFS:</strong> {{ \Carbon\Carbon::parse($getUpgrade->tanggal_rfs)->translatedFormat('d M Y') }}</p>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <!-- Tombol Approve -->
                                    <form action="{{ route('psb.upgrade.approve', $getUpgrade->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        <button type="button" class="btn btn-sm btn-success" onclick="confirmApproval('{{ route('psb.upgrade.approve', $getUpgrade->id) }}')">
                                    ...
                                    <a href="{{ route('psb_upgrade_add_progress', $getUpgrade->id) }}"
                                        class="btn btn-info btn-sm mb-2">
                                        <i class="fa fa-plus"></i> Add Progress
                                    </a>

                                    <a href="{{ route('psb.upgrade.print', $getUpgrade->id) }}"
                                        class="btn btn-info btn-sm mb-2">
                                    ...
                                    <!-- Tombol Kembali -->
                                    <a href="{{ route('psb.upgrade') }}" class="btn btn-sm btn-info mt-2">
