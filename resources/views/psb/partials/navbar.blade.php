<nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
        <a class="navbar-brand brand-logo" href="{{ url('psb/dashboard') }}"><img src="{{asset('mailler/img/pc24.png')}}" alt="logo" style="width: 200px; height: auto;" /></a>
        <a class="navbar-brand brand-logo-mini" href="{{ url('psb/dashboard') }}"><img src="{{asset('mailler/img/pc24.png')}}" alt="logo" /></a>
    </div>
        ...
        <ul class="navbar-nav navbar-nav-right">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu navbar-dropdown" aria-labelledby="messageDropdown">
                    <a class="dropdown-item" href="{{ url('psb/chat') }}">
                        <i class="mdi mdi-message-text me-2 text-success"></i> Chat
                    </a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="{{ url('psb/users') }}">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end navbar-dropdown preview-list notifications-dropdown" aria-labelledby="notificationDropdown">
                    ...
                    <form id="mark-as-read-form-{{ $notification->id }}" action="{{ route('notifications.markAsReadPsb', $notification->id) }}" method="POST" style="display:none;">
                        @csrf
                        @method('PATCH')
                    </form>
