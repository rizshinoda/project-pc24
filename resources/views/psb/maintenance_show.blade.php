                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('psb_maintenance_add_progress', $getMaintenance->id) }}" class="btn btn-info mb-3">
                                        Add Progress</a>
                                    <a href="{{ route('psb.maintenance.print', $getMaintenance->id) }}" class="btn btn-info pull-right mb-3">Cetak SPK</a>
                                    ...
                                    <!-- Tombol Kembali -->
                                    <a href="{{ route('psb.maintenance') }}" class="btn btn-info mt-3">
