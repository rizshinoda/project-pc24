                        ...
                        <div class="col">
                            <div class="card h-100">
                                <div class="card-body ">
                                    ...
                                    <div class="mt-5">
                                        <!-- Tombol Approve -->
                                        <form action="{{ route('psb.maintenance.approve', $getMaintenance->id) }}" method="POST" style="display:inline;">
                                            @csrf
                                            <button type="button" class="btn btn-success" onclick="confirmApproval('{{ route('psb.maintenance.approve', $getMaintenance->id) }}')">
                                                <i class="fa fa-check"></i> Approve
                                            </button>
                                        </form>

                                        <!-- Tombol Reject -->
                                        <form action="{{ route('psb.maintenance.reject', $getMaintenance->id) }}" method="POST" style="display:inline;">
                                            @csrf
                                            <button type="button" class="btn btn-danger" onclick="confirmRejection('{{ route('psb.maintenance.reject', $getMaintenance->id) }}')">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('psb_maintenance_add_progress', $getMaintenance->id) }}" class="btn btn-sm btn-info mb-2"><i class="fa fa-plus"></i>
                                        Add Progress</a>
                                    <a href="{{ route('psb.maintenance.print', $getMaintenance->id) }}" class="btn btn-sm btn-info  mb-2"><i class="fa fa-print"></i>Cetak SPK</a>
                                    ...
                                    <!-- Tombol Kembali -->
                                    <a href="{{ route('psb.maintenance') }}" class="btn btn-sm btn-info mt-2">
