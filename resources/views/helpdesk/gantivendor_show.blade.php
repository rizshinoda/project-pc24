                ...
                <div class="content-wrapper">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="list-group">
                                        ...
                                        @foreach($getGantivendor->attachments as $index => $file)
                                        ...
                                        <div class="list-group-item d-flex justify-content-between align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <form
                                                    ...
                                                    action="{{ route('attachment.delete.hd',[
                                                'type'=>$woType,
                                                'id'=>$getGantivendor->id,
                                                'index'=>$index
                                        ]) }}"
                                                    method="POST"
                                                    class="d-inline">
                    ...
                    <div class="modal fade" id="uploadAttachment">
                        ...
                        <div class="modal-dialog">
                            ...
                            <form
                                action="{{ route('attachment.store.hd',[
                    'type'=>$woType,
                    'id'=>$getGantivendor->id
            ]) }}"
                                method="POST"
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('hd_gantivendor_add_progress', $getGantivendor->id) }}" class="btn btn-sm btn-info mb-2"><i class="fa fa-plus">
                                        </i>
                                        Add Progress</a>
                                    ...
                                    <!-- Tombol Kembali -->
                                    <a href="{{ route('hd.gantivendor') }}" class="btn btn-sm btn-info mt-2">
