                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('hd.downgrade.approve', $getDowngrade->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        <button type="button" class="btn btn-sm btn-success" onclick="confirmApproval('{{ route('hd.downgrade.approve', $getDowngrade->id) }}')">
                                    ...
                                    <a href="{{ route('hd_downgrade_add_progress', $getDowngrade->id) }}"
                                    ...
                                    <!-- Tombol Kembali -->
                                    <a href="{{ route('hd.downgrade') }}" class="btn btn-sm btn-info mt-2">
