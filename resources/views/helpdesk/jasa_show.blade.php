                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    @if ($getInstall->status === 'On Progress' || $getInstall->status === 'Shipped' || $getgetInstallRelokasi->status === 'Completed')
                                    <a href="{{ route('hd_jasa_add_progress', $getInstall->id) }}"
                                    ...
                                    <!-- Tombol Kembali -->
                                    <a href="{{ route('hd.jasa') }}" class="btn btn-sm btn-info mt-2">
