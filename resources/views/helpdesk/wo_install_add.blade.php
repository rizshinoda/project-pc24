                ...
                <div class="content-wrapper">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-6"> <!-- Lebar form setengah halaman -->
                            <div class="card">
                                <div class="card-body">
                                    <a href="{{ route('hd.instalasi.show', $getInstall->id) }}" class="btn btn-sm btn-info"> <i class="fa fa-arrow-left"></i></a>

                                    <h4 class="mb-5 text-center">Update Progress Instalasi</h4>

                                    {{-- Form untuk mengupload multiple foto --}}
                                    <form action="{{ route('hd_install_add_progress', $getInstall->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
