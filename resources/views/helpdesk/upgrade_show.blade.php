                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <!-- Tombol Approve -->
                                    <form action="{{ route('hd.upgrade.approve', $getUpgrade->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        <button type="button" class="btn btn-sm btn-success" onclick="confirmApproval('{{ route('hd.upgrade.approve', $getUpgrade->id) }}')">
                                    ...
                                    <a href="{{ route('hd_upgrade_add_progress', $getUpgrade->id) }}"
                                    ...
                                    <!-- Tombol Kembali -->
                                    <a href="{{ route('hd.upgrade') }}" class="btn btn-sm btn-info mt-2">
