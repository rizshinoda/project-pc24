                ...
                <div class="content-wrapper">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-6"> <!-- Lebar form setengah halaman -->
                            <div class="card">
                                <div class="card-body">
                                    <a href="{{ route('hd.relokasi.show', $getRelokasi->id) }}" class="btn btn-sm btn-info"> <i class="fa fa-arrow-left"></i></a>

                                    <h4 class="mb-5 text-center">Update Progress Relokasi</h4>
                                    {{-- Form untuk mengupload multiple foto --}}
                                    <form action="{{ route('hd_relokasi_add_progress', $getRelokasi->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="form-group text-center">
                                            ...
                                            <button type="button"
                                                ...
                                                data-title="Selesaikan Relokasi?"
                                                data-text="Progress Relokasi akan ditandai sebagai Completed dan tidak bisa diubah kembali."
                                                data-action="complete">
                                                Selesaikan Proses Relokasi
                                            </button>
                                        </div>
                                    </form>
                                </div>
