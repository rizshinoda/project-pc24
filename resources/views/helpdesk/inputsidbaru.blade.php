                        ...
                        <div class="col-md-4">
                            <div class="card">
                                ...
                                @endif -->
                                    ...
                                    <form action="{{ route('hd.gantivendor.storesidbaru', ['id' => $getGantivendor->id]) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="text-center">
                                            ...
                                            <a href="{{ route('hd.gantivendor.show', $getGantivendor->id) }}" class="btn btn-light mt-1">Kembali</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
