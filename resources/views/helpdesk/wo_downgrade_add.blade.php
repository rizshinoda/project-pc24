                ...
                <div class="content-wrapper">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-6"> <!-- Lebar form setengah halaman -->
                            <div class="card">
                                <div class="card-body">
                                    <a href="{{ route('hd.downgrade_show', $getDowngrade->id) }}" class="btn btn-sm btn-info"> <i class="fa fa-arrow-left"></i></a>

                                    <h4 class="mb-5 text-center">Update Progress Downgrade</h4>
                                    {{-- Form untuk mengupload multiple foto --}}
                                    <form action="{{ route('hd_downgrade_add_progress', $getDowngrade->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
