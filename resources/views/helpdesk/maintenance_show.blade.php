                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('hd_maintenance_add_progress', $getMaintenance->id) }}" class="btn btn-sm btn-info mb-2"><i class="fa fa-plus"></i>
                                        Add Progress</a>
                                    ...
                                    <!-- Tombol Kembali -->
                                    <a href="{{ route('hd.maintenance') }}" class="btn btn-sm btn-info mt-2">
