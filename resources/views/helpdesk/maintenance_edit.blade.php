                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('hd.maintenance_update', $workOrder->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                                ...
                                                <div class="col-sm-8">
                                                    <table class="table table-bordered mt-2" id="cart-table">
                                                        ...
                                                        <tbody id="cart-table-body">
                                                            ...
                                                            @foreach ($WorkOrderMaintenanceDetail as $detail)
                                    ...
                                    <a href="{{ route('hd.maintenance') }}" class="btn btn-light">Kembali</a>
