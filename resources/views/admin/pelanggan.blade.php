                                ...
                                <div class=" table-responsive">
                                    ...
                                    <table class="table table-hover wrap">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style=" text-align: center; vertical-align: middle;">{{$pelanggans->firstItem()+ $key}} </td>
                                                ...
                                                <td>
                                                    @if ($pelanggan->foto)
                                                    <img src="{{ url('storage/pelanggan/' . $pelanggan->foto) }}" alt="Foto Pelanggan" class="img-fluid square-image" style="width: 100px;">
                                                    @endif
                                                </td>
