                        ...
                        <div class="col">
                            <div class="card h-100">
                                <div class="card-body ">
                                    ...
                                    <div class="mt-5">
                                        <!-- Tombol Approve -->
                                        <form action="{{ route('admin.gantivendor.approve', $getGantivendor->id) }}" method="POST" style="display:inline;">
                                            @csrf
                                            <button type="button" class="btn btn-success" onclick="confirmApproval('{{ route('admin.gantivendor.approve', $getGantivendor->id) }}')">
                                                <i class="fa fa-check"></i> Approve
                                            </button>
                                        </form>

                                        <!-- Tombol Reject -->
                                        <form action="{{ route('admin.gantivendor.reject', $getGantivendor->id) }}" method="POST" style="display:inline;">
                                            @csrf
                                            <button type="button" class="btn btn-danger" onclick="confirmRejection('{{ route('admin.gantivendor.reject', $getGantivendor->id) }}')">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    @if (!empty($getGantivendor->attachments))
                                    <div class="list-group">
                                        @foreach ($getGantivendor->attachments as $file)
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('admin.gantivendor.input', $getGantivendor->id) }}" class="btn btn-sm btn-info mb-3"> <i class="fa fa-plus"></i>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    @if ($getGantivendor->status === 'Rejected')
                                    <a href="{{ route('admin_gantivendor_add_progress', $getGantivendor->id) }}"
                                    ...
                                    <!-- Tombol Kembali -->
                                    <a href="{{ route('admin.gantivendor') }}" class="btn btn-sm btn-info mt-2">
