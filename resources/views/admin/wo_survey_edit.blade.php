...
<body>
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="mb-5 text-center">Edit Survey</h4>
    ...
    @endif -->
                                ...
                                <form action="{{ route('admin.wo_survey_update', ['id' => $getSurvey->id]) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <input type="text" name="no_spk" id="no_spk" class="form-control" value="{{ old('no_spk', $getSurvey->no_spk) }}" readonly>
                                                </div>
                                            </div>
                                            <!-- Kolom pertama -->
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <div class="mt-3">
                                                        <img src="{{ asset('storage/pelanggan/' . $getSurvey->pelanggan->foto) }}" alt="Foto Pelanggan" class="img-fluid" width="200">
                                                    </div>
                                                    @else
