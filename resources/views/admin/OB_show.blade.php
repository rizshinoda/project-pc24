                            ...
                            <div class="card h-100">
                                <div class="card-body ">
                                    ...
                                    <p><strong>Tanggal Instalasi:</strong>
                                        {{ $onlinebilling->tanggal_instalasi ? \Carbon\Carbon::parse($onlinebilling->tanggal_instalasi)->translatedFormat('d M Y'): '-' }}
                                    </p>
                                    ...
                                    <p><strong>Tanggal Akhir:</strong> {{ $onlinebilling->tanggal_akhir ?  \Carbon\Carbon::parse($onlinebilling->tanggal_akhir)->translatedFormat('d M Y'): '-'}} </p>
                        ...
                        <div class="col">
                            <div class="card h-100">
                                <div class="card-body">
                                    ...
                                    <p><strong>Media:</strong> {{ $onlinebilling->media }}</p>
                        ...
                        <div class="col-md-12">
                            <div>
                                <div class="card-body text-center">
                                    <a href="{{ route('admin.upgrade_create', $onlinebilling->id) }}" class="btn btn-success btn-sm ">
                                        Upgrade
                                    </a>
                                    <a href="{{ route('admin.downgrade_create', $onlinebilling->id) }}" class="btn btn-warning btn-sm ">
                                        Downgrade
                                    </a>
                                    <a href="{{ route('admin.dismantle_create', $onlinebilling->id) }}" class="btn btn-danger btn-sm ">
                                        Dismantle
                                    </a>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('admin.OB') }}" class="btn btn-info mt-3"><i class="fa fa-arrow-left"></i> Kembali</a>
