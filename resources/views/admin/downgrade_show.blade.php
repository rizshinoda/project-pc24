                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="list-group">
                                        ...
                                        @foreach($getDowngrade->attachments as $index => $file)
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('admin_downgrade_add_progress', $getDowngrade->id) }}"
                                    ...
                                    <!-- Tombol Kembali -->
                                    <a href="{{ route('admin.downgrade') }}" class="btn btn-sm btn-info mt-2">
                            ...
                            <div class="card shadow-sm border-0">
                                <div class="card-body p-4">
                                    ...
                                    <form action="{{ route('berita_acara.store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <input type="hidden" name="work_order_id" value="{{ $getDowngrade->id }}">
                                        <input type="hidden" name="work_order_type" value="downgrade">
