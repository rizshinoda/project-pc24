                ...
                <div class="content-wrapper">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-6"> <!-- Lebar form setengah halaman -->
                            <div class="card">
                                <div class="card-body">
                                    <a href="{{ route('admin.dismantle_show', $getDismantle->id) }}" class="btn btn-sm btn-info"> <i class="fa fa-arrow-left"></i></a>

                                    <h4 class="mb-5 text-center">Update Progress Dismantle</h4>
                                    {{-- Form untuk mengupload multiple foto --}}
                                    <form action="{{ route('admin_dismantle_add_progress', $getDismantle->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="form-group text-center">
                                            ...
                                            <button type="button"
                                                ...
                                                data-title="Selesaikan Dismantle?"
                                                data-text="Progress Dismantle akan ditandai sebagai Completed dan tidak bisa diubah kembali."
                                                data-action="complete">
                                                Selesaikan Proses Dismantle
                                            </button>
                                        </div>
                                    </form>
                                </div>
