                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="list-group">
                                        ...
                                        @foreach($getSurvey->attachments as $index => $file)
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('admin_survey_add_progress', $getSurvey->id) }}"
                            ...
                            <div class="card shadow-sm border-0">
                                <div class="card-body p-4">
                                    ...
                                    <form action="{{ route('berita_acara.store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <input type="hidden" name="work_order_id" value="{{ $getSurvey->id }}">
                                        <input type="hidden" name="work_order_type" value="survey">
