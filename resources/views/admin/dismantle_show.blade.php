                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    @if(!empty($getDismantle->attachments))

                                    <div class="list-group">

                                        @foreach($getDismantle->attachments as $index => $file)
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    @if ($getDismantle->status === 'On Progress' || $getDismantle->status === 'Shipped' || $getDismantle->status === 'Completed')
                                    <a href="{{ route('admin_dismantle_add_progress', $getDismantle->id) }}"
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <!-- Tombol Kembali -->
                                    <a href="{{ route('admin.dismantle') }}" class="btn btn-sm btn-info mt-2">
                            ...
                            <div class="card shadow-sm border-0">
                                <div class="card-body p-4">
                                    ...
                                    <form action="{{ route('berita_acara.store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <input type="hidden" name="work_order_id" value="{{ $getDismantle->id }}">
                                        <input type="hidden" name="work_order_type" value="dismantle">
