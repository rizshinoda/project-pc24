                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('admin.request_barang.update', $requestBarang->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="nama_penerima" name="nama_penerima" placeholder="Masukkan Nama Penerima" value="{{ $requestBarang->nama_penerima }}" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" id="alamat_penerima" name="alamat_penerima" class="form-control" placeholder="Masukkan Alamat Penerima" value="{{ $requestBarang->alamat_penerima }}" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" id="no_penerima" name="no_penerima" class="form-control" placeholder="Masukkan No. Penerima" value="{{ $requestBarang->no_penerima }}" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <select id="jenis_id" name="jenis_id" class="form-control">
                                                        ...
                                                        <option value="{{ $jenis->id }}" {{ $jenis->id == $requestBarang->jenis_id ? 'selected' : '' }}>{{ $jenis->nama_jenis }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" id="search" class="form-control" placeholder="Cari berdasarkan merek atau tipe" />
                                                ...
                                                <div class="col-sm-8">
                                                    <table class="table table-bordered mt-2" id="cart-table">
                                                        ...
                                                        <tbody id="cart-table-body">
                                                            ...
                                                            @foreach ($requestBarangDetails as $detail)
