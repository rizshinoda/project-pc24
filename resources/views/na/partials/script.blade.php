...
<script>
    ...
    const routeMap = {
        ...
        'Instalasi': '{{ route("na.instalasi") }}',

        'POC': '{{ route("na.poc") }}',

        'Jasa': '{{ route("na.jasa") }}',

        'Maintenance': '{{ route("na.maintenance") }}',

        'Dismantle': '{{ route("na.dismantle") }}',

        'Upgrade': '{{ route("na.upgrade") }}',

        'Downgrade': '{{ route("na.downgrade") }}',

        'Relokasi': '{{ route("na.relokasi") }}',

        'Ganti Vendor': '{{ route("na.gantivendor") }}',
