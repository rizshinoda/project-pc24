        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <form action="{{ route('na_gantivendor_add_progress', $getGantivendor->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            <a href="{{ route('na.gantivendor.show', $getGantivendor->id) }}" class="btn btn-info"><i class="fa fa-arrow-left"></i> Kembali</a>
