                        ...
                        <div class="col">
                            <div class="card h-100">
                                <div class="card-body ">
                                    ...
                                    <p><strong>Tanggal Akhir:</strong> {{ $onlinebilling->tanggal_akhir ?  \Carbon\Carbon::parse($onlinebilling->tanggal_akhir)->translatedFormat('d M Y'): '-r'}} </p>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('na.OB') }}" class="btn btn-info mt-3"><i class="fa fa-arrow-left"></i> Kembali</a>
