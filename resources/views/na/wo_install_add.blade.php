        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <form action="{{ route('na_install_add_progress', $getInstall->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            <a href="{{ route('na.instalasi.show', $getInstall->id) }}" class="btn btn-info"><i class="fa fa-arrow-left"></i> Kembali</a>
