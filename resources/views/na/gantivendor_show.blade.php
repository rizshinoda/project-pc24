                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('na.gantivendor.inputsidbaru', $getGantivendor->id) }}" class="btn btn-info mb-3">
                                        Input SID Baru</a>
                                    @endif
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('na_gantivendor_add_progress', $getGantivendor->id) }}" class="btn btn-sm btn-info mb-2"><i class="fa fa-plus"></i>
                                        Add Progress</a>
                                    ...
                                    <!-- Tombol Kembali -->
                                    <a href="{{ route('na.gantivendor') }}" class="btn btn-sm btn-info mt-2">
