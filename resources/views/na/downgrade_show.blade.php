                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <!-- Tombol Approve -->
                                    <form action="{{ route('na.downgrade.approve', $getDowngrade->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        <button type="button" class="btn btn-sm btn-success" onclick="confirmApproval('{{ route('na.downgrade.approve', $getDowngrade->id) }}')">
                                    ...
                                    <a href="{{ route('na_downgrade_add_progress', $getDowngrade->id) }}"
                                    ...
                                    <!-- Tombol Kembali -->
                                    <a href="{{ route('na.downgrade') }}" class="btn btn-sm btn-info mt-2">
