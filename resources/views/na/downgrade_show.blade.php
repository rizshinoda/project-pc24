                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('na.downgrade.approve', $getDowngrade->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        <button type="button" class="btn btn-success" onclick="confirmApproval('{{ route('na.downgrade.approve', $getDowngrade->id) }}')">
                                    ...
                                    <a href="{{ route('na_downgrade_add_progress', $getDowngrade->id) }}" class="btn btn-info mb-3">
                                        Add Progress</a>
                                    ...
                                    <!-- Tombol Kembali -->
                                    <a href="{{ route('na.downgrade') }}" class="btn btn-info mt-3">
