                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('na.upgrade.approve', $getUpgrade->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        <button type="button" class="btn btn-sm btn-success" onclick="confirmApproval('{{ route('na.upgrade.approve', $getUpgrade->id) }}')">
                                    ...
                                    <a href="{{ route('na_upgrade_add_progress', $getUpgrade->id) }}"
                                    ...
                                    <!-- Tombol Kembali -->
                                    <a href="{{ route('na.upgrade') }}" class="btn btn-sm btn-info mt-2">
