                        ...
                        <div class="col">
                            <div class="card h-100">
                                <div class="card-body ">
                                    ...
                                    <div class="mt-5">
                                        <!-- Tombol Approve -->
                                        <form action="{{ route('ga.maintenance.approve', $getMaintenance->id) }}" method="POST" style="display:inline;">
                                            @csrf
                                            <button type="button" class="btn btn-success" onclick="confirmApproval('{{ route('ga.maintenance.approve', $getMaintenance->id) }}')">
                                                <i class="fa fa-check"></i> Approve
                                            </button>
                                        </form>

                                        <!-- Tombol Reject -->
                                        <form action="{{ route('ga.maintenance.reject', $getMaintenance->id) }}" method="POST" style="display:inline;">
                                            @csrf
                                            <button type="button" class="btn btn-danger" onclick="confirmRejection('{{ route('ga.maintenance.reject', $getMaintenance->id) }}')">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class=" table-responsive">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style=" text-align: center; vertical-align: middle;">
                                                        ...
                                                        <form id="cancelForm{{ $barangKeluar->id }}" action="{{ route('ga.cancel_barang.maintenance', $barangKeluar->id) }}" method="POST" style="display: none;">
                                                            @csrf
                                                            @method('DELETE')
                                                        </form>
                                        ...
                                        <a href="{{ route('ga.maintenance_barang.printdetailbarang', $getMaintenance->id) }}"
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <!-- Tombol Kembali -->
                                    <a href="{{ route('ga.maintenance') }}" class="btn btn-info mt-3">
