                ...
                <div class="content-wrapper">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="mb-5 text-center">Form Edit Merek</h4>

                                    {{-- Form untuk membuat work order --}}
                                    <form action="{{ route('updateMerek', $mereks->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <input type="text" name="nama_merek" id="nama_merek" class="form-control" value="{{ old('nama_merek', $mereks->nama_merek) }}" required>
