                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="submitBarangForm" method="POST" action="{{ route('ga.input_barang_maintenance.store', $getMaintenance->id) }}">
                                    @csrf
                                    ...
                                    <a href="{{ route('ga.maintenance_show', $getMaintenance->id) }}" class="btn btn-info mt-3"><i class="fa fa-arrow-left"></i> Kembali</a>
