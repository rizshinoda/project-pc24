...
<body onload="window.print()">
    ...
    <table class="no-border">
        <tr>
            <td width="60%">
                No Jaringan : {{ $getUpgrade->onlineBilling->no_jaringan ?? '-' }}<br>
                Nama Site : {{ $getUpgrade->onlineBilling->nama_site ?? '-' }}<br>
                Alamat : {{ $getUpgrade->alamat_penerima }}<br>
                VLAN : -
            </td>
    ...
    <table>
        ...
        <tbody>
            @foreach($getUpgrade->barangKeluar as $item)
            <tr>
