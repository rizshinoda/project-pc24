...
<body onload="window.print()">
    ...
    <table class="no-border">
        <tr>
            <td width="60%">
                No Jaringan : {{ $getInstall->no_jaringan ?? '-' }}<br>
                Nama Site : {{ $getInstall->nama_site ?? '-'}}<br>
                Alamat : {{ $getInstall->alamat_pemasangan }}<br>
                VLAN : -
            </td>
    ...
    <table>
        ...
        <tbody>
            @foreach($getInstall->barangKeluar as $item)
            <tr>
