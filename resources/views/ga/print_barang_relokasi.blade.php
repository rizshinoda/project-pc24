...
<body onload="window.print()">
    ...
    <table class="no-border">
        <tr>
            <td width="60%">
                No Jaringan : {{ $getRelokasi->onlineBilling->no_jaringan ?? '-' }}<br>
                Nama Site : {{ $getRelokasi->onlineBilling->nama_site ?? '-' }}<br>
                Alamat : {{ $getRelokasi->alamat_penerima }}<br>
                VLAN : -
            </td>
    ...
    <table>
        ...
        <tbody>
            @foreach($getRelokasi->barangKeluar as $item)
            <tr>
