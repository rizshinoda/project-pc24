                ...
                <div class="content-wrapper">
                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="{{route('createMerek')}}" class="btn btn-info btn-sm mb-4 ">Tambah Data</a>
                                    ...
                                    <table class="table table-hover wrap">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="text-align: center; vertical-align: middle;">Merek Barang</th>
                                                <th style="text-align: center; vertical-align: middle;">Aksi</th>

                                            </tr>
                                        </thead>
                                        <tbody>
                                            @foreach ($mereks as $key => $merek)
                                            <tr>
                                                <td style=" text-align: center; vertical-align: middle;">{{$mereks->firstItem()+ $key}} </td>
                                                <td style="text-align: center; vertical-align: middle;">{{$merek->nama_merek}}</td>


                                                <td style="text-align: center; vertical-align: middle;">
                                                    <!-- Tombol Edit -->
                                                    <a href="{{ route('editMerek', $merek->id) }}" class="btn btn-sm btn-warning" style="display:inline-block; "><i class="fa fa-edit"></i></a>
