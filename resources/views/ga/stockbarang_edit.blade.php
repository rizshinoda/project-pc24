            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="mb-5 text-center">Form Edit Barang</h4>
                                ...
                                <form action="{{ route('stockbarang_update', $stockBarang->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <select name="jenis_id" id="jenis_id" class="form-control" required>
                                                        ...
                                                        @foreach ($jenis as $j)
                                                        <option value="{{ $j->id }}" {{ $stockBarang->jenis_id == $j->id ? 'selected' : '' }}>
                                                            {{ $j->nama_jenis }}
                                                        </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="form-group row">
                                                <label for="merek_id" class="col-sm-4 col-form-label">Merek Barang</label>
                                                <div class="col-sm-8">
                                                    <select name="merek_id" id="merek_id" class="form-control" required>
                                                        <option value="">Pilih Merek</option>
                                                        @foreach ($mereks as $m)
                                                        <option value="{{ $m->id }}" {{ $stockBarang->merek_id == $m->id ? 'selected' : '' }}>
                                                            {{ $m->nama_merek }}
                                                        </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="form-group row">
                                                <label for="tipe_id" class="col-sm-4 col-form-label">Tipe Barang</label>
                                                <div class="col-sm-8">
                                                    <select name="tipe_id" id="tipe_id" class="form-control" required>
                                                        <option value="">Pilih Tipe</option>
                                                        @foreach ($tipes as $t)
                                                        <option value="{{ $t->id }}" {{ $stockBarang->tipe_id == $t->id ? 'selected' : '' }}>
                                                            {{ $t->nama_tipe }}
                                                        </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="serial_number" name="serial_number"
                                                        value="{{ $stockBarang->serial_number }}" placeholder="Masukkan serial number">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <select name="kualitas" class="form-control" required>
                                                        <option value="baru" {{ $stockBarang->kualitas == 'baru' ? 'selected' : '' }}>Baru</option>
                                                        <option value="bekas" {{ $stockBarang->kualitas == 'bekas' ? 'selected' : '' }}>Bekas</option>
                                                    </select>
                                                </div>
                                            </div>
