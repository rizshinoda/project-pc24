                        ...
                        <div class="col">
                            <div class="card h-100">
                                <div class="card-body ">
                                    ...
                                    <div class="mt-5">
                                        <!-- Tombol Approve -->
                                        <form action="{{ route('ga.jasa.approve', $getInstall->id) }}" method="POST" style="display:inline;">
                                            @csrf
                                            <button type="button" class="btn btn-success" onclick="confirmApproval('{{ route('ga.jasa.approve', $getInstall->id) }}')">
                                                <i class="fa fa-check"></i> Approve
                                            </button>
                                        </form>

                                        <!-- Tombol Reject -->
                                        <form action="{{ route('ga.jasa.reject', $getInstall->id) }}" method="POST" style="display:inline;">
                                            @csrf
                                            <button type="button" class="btn btn-danger" onclick="confirmRejection('{{ route('ga.jasa.reject', $getInstall->id) }}')">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between mb-3">
                                        ...
                                        <div>
                                            ...
                                            <a href="{{ route('ga.input_barang_jasa.create', $getInstall->id) }}" class="btn btn-info">Input Barang</a>
                                            @endif
                                        </div>
                                        ...
                                        <div>
                                            @if ($getInstall->status === 'On Progress' || $getInstall->status === 'Shipped' )
                                            <a href="javascript:void(0);" id="btn-kirim-perangkat" data-url="{{ route('ga.jasa.create.shipped', $getInstall->id) }}" class="btn btn-primary">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style=" text-align: center; vertical-align: middle;">
                                                        ...
                                                        <form id="cancelForm{{ $barangKeluar->id }}" action="{{ route('ga.cancel_barang.jasa', $barangKeluar->id) }}" method="POST" style="display: none;">
                                                            @csrf
                                                            @method('DELETE')
                                                        </form>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <!-- Tombol Kembali -->
                                    <a href="{{ route('ga.jasa') }}" class="btn btn-info mt-3">
