            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <a href="{{ route('ga.stockbarang_create') }}" class="btn btn-sm btn-info mb-4">Tambah Barang</a>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-4">
                                        <select id="merekFilter" class="form-control">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered wrap">
                                        ...
                                        <tbody id="stockTableBody">
                                            ...
                                            <tr data-jenis="{{ $stock->jenis->id }}" data-merek="{{ $stock->merek->id }}" data-tipe="{{ $stock->tipe->id }}">
                                                <td style="text-align: center; vertical-align: middle;">{{ $key + 1 }}</td>
                                                <td style="text-align: center; vertical-align: middle;">{{ $stock->jenis->nama_jenis }}</td>
                                                <td style="text-align: center; vertical-align: middle;">{{ $stock->merek->nama_merek }}</td>
                                                <td style="text-align: center; vertical-align: middle;">{{ $stock->tipe->nama_tipe }}</td>
                                                <td style="text-align: center; vertical-align: middle;">{{ $stock->serial_number }}</td>
                                                <td style="text-align: center; vertical-align: middle;">{{ $stock->jumlah }}</td>
                                                <td style="text-align: center; vertical-align: middle;">{{ ucfirst($stock->kualitas) }}</td>
                                                <td style="text-align: center; vertical-align: middle;">
                                                    <a href=" {{ route('stockbarang_edit', $stock->id) }}" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>
