...
<body onload="window.print()">
    ...
    <table class="no-border">
        <tr>
            <td width="60%">
                No Jaringan : {{ $requestBarang->onlineBilling->no_jaringan ?? '-' }}<br>
                Nama Site : {{ $requestBarang->onlineBilling->nama_site ?? $requestBarang->subject_manual }}<br>
                Alamat : {{ $requestBarang->alamat_penerima }}<br>
                VLAN : -
            </td>
    ...
    <table>
        ...
        <tbody>
            @foreach($requestBarang->barangKeluar as $item)
            <tr>
