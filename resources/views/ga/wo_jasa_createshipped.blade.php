                ...
                <div class="content-wrapper">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-6"> <!-- Lebar form setengah halaman -->
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="mb-5 text-center">Progress Shipping Jasa</h4>
                                    {{-- Form untuk mengupload multiple foto --}}
                                    <form action="{{ route('ga.jasa.store.shipped', $getInstall->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="text-center">
                                            ...
                                            <a href="{{ route('ga.jasa_show', $getInstall->id) }}" class="btn btn-light ">Kembali</a>
