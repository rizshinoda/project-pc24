                ...
                <div class="content-wrapper">
                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="{{route('createTipe')}}" class="btn btn-info btn-sm mb-4 ">Tambah Data</a>
                                    ...
                                    <table class="table table-hover wrap">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="text-align: center; vertical-align: middle;">Nama Tipe</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="text-align: center; vertical-align: middle;">{{$tipes->firstItem()+ $key}}</td>
                                                <td style="text-align: center; vertical-align: middle;">{{ $tipe->merek->nama_merek }}</td>
                                                <td style="text-align: center; vertical-align: middle;" s>{{ $tipe->nama_tipe }}</td>

                                                <td style="text-align: center; vertical-align: middle;">
                                                    <!-- Tombol Edit -->
                                                    <a href="{{ route('editTipe', $tipe->id) }}" class="btn btn-sm btn-warning" style="display:inline-block; "><i class="fa fa-edit"></i></a>
