                ...
                <div class="content-wrapper">
                        ...
                        <div class="col">
                            <div class="card h-100">
                                <div class="card-body ">
                                    ...
                                    <div class="mt-5">
                                        <!-- Tombol Approve -->
                                        <form action="{{ route('ga.poc.approve', $getInstall->id) }}" method="POST" style="display:inline;">
                                            @csrf
                                            <button type="button" class="btn btn-success" onclick="confirmApproval('{{ route('ga.poc.approve', $getInstall->id) }}')">
                                                <i class="fa fa-check"></i> Approve
                                            </button>
                                        </form>

                                        <!-- Tombol Reject -->
                                        <form action="{{ route('ga.poc.reject', $getInstall->id) }}" method="POST" style="display:inline;">
                                            @csrf
                                            <button type="button" class="btn btn-danger" onclick="confirmRejection('{{ route('ga.poc.reject', $getInstall->id) }}')">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style=" text-align: center; vertical-align: middle;">
                                                        ...
                                                        <form id="cancelForm{{ $barangKeluar->id }}" action="{{ route('ga.cancel_barang.poc', $barangKeluar->id) }}" method="POST" style="display: none;">
                                                            @csrf
                                                            @method('DELETE')
                                                        </form>
                    ...
                    <div class="row mt-4">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Progres POC</h4>
                                    ...
                                    <!-- Tombol Kembali -->
                                    <a href="{{ route('ga.poc') }}" class="btn btn-info mt-3">
