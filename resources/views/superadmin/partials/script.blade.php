...
<script>
    ...
    const routeMap = {
        ...
        'Survey': '{{ route("superadmin.survey") }}',

        'Instalasi': '{{ route("superadmin.instalasi") }}',

        'POC': '{{ route("superadmin.poc") }}',

        'Jasa': '{{ route("superadmin.jasa") }}',

        'Maintenance': '{{ route("superadmin.maintenance") }}',

        'Dismantle': '{{ route("superadmin.dismantle") }}',

        'Upgrade': '{{ route("superadmin.upgrade") }}',

        'Downgrade': '{{ route("superadmin.downgrade") }}',

        'Relokasi': '{{ route("superadmin.relokasi") }}',

        'Ganti Vendor': '{{ route("superadmin.gantivendor") }}',
