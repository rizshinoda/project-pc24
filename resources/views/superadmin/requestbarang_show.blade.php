                    ...
                    <div class="col-md-4 mb-1">
                        <div class="card fixed-card d-flex h-100">
                            <div class="card-body ">
                                ...
                                <!-- resources/views/user/request_barang/create.blade.php -->
                                ...
                                <p><strong>Status:</strong> @if($requestBarang->status=='pending')
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('superadmin.request_barang') }}" class="btn btn-info mt-3"><i class="fa fa-arrow-left"></i> Kembali</a>
