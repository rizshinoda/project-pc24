            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <form action="{{ route('noc_maintenance_add_progress', $getMaintenance->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <a href="{{ route('noc.maintenance_show', $getMaintenance->id) }}" class="btn btn-info"> <i class="fa fa-arrow-left"></i> Kembali</a>
                            ...
                            <button type="submit" name="action" value="complete" class="btn btn-success pull-right">Selesaikan Proses Maintenance</button>
                        </div>
                    </form>
                </div>
