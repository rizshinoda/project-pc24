        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <form action="{{ route('noc_upgrade_add_progress', $getUpgrade->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            <a href="{{ route('noc.upgrade_show', $getUpgrade->id) }}" class="btn btn-info"> <i class="fa fa-arrow-left"></i> Kembali</a>
