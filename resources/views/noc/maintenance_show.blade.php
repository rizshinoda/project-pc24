                        ...
                        <div class="col">
                            <div class="card h-100">
                                <div class="card-body ">
                                    ...
                                    <div class="mt-5">
                                        <form action="{{ route('noc.maintenance.approve', $getMaintenance->id) }}" method="POST" style="display:inline;">
                                            @csrf
                                            <button type="button" class="btn btn-success" onclick="confirmApproval('{{ route('noc.maintenance.approve', $getMaintenance->id) }}')">
                                                <i class="fa fa-check"></i> Approve
                                            </button>
                                        </form>

                                        <form action="{{ route('noc.maintenance.reject', $getMaintenance->id) }}" method="POST" style="display:inline;">
                                            @csrf
                                            <button type="button" class="btn btn-danger" onclick="confirmRejection('{{ route('noc.maintenance.reject', $getMaintenance->id) }}')">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('noc_maintenance_add_progress', $getMaintenance->id) }}" class="btn btn-info mb-3">
                                        Add Progress</a>
                                    ...
                                    <!-- Tombol Kembali -->
                                    <a href="{{ route('noc.maintenance') }}" class="btn btn-info mt-3">
