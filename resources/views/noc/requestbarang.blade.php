                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="GET" action="{{ route('noc.request_barang') }}" class="mb-4">
                                    <div class="row">
                                        <!-- Kolom Pencarian -->
                                        ...
                                        <div class="">
                                            ...
                                            <a href="{{route('noc.request_barang.create')}}" class="btn btn-info btn-sm mb-4 ">Buat Request</a>
                                ...
                                <ul class="nav nav-tabs justify-content-center mb-4" id="surveyTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link {{ $status == 'all' ? 'active' : '' }}" href="{{ route('noc.request_barang', ['status' => 'all', 'search' => request('search'), 'month' => request('month'), 'year' => request('year')]) }}">Semua</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link {{ $status == 'pending' ? 'active' : '' }}" href="{{ route('noc.request_barang', ['status' => 'pending', 'search' => request('search'), 'month' => request('month'), 'year' => request('year')]) }}">Pending</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link {{ $status == 'approved' ? 'active' : '' }}" href="{{ route('noc.request_barang', ['status' => 'approved', 'search' => request('search'), 'month' => request('month'), 'year' => request('year')]) }}">Approved</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link {{ $status == 'rejected' ? 'active' : '' }}" href="{{ route('noc.request_barang', ['status' => 'rejected', 'search' => request('search'), 'month' => request('month'), 'year' => request('year')]) }}">Rejected</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link {{ $status == 'shipped' ? 'active' : '' }}" href="{{ route('noc.request_barang', ['status' => 'shipped', 'search' => request('search'), 'month' => request('month'), 'year' => request('year')]) }}">Shipped</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link {{ $status == 'completed' ? 'active' : '' }}" href="{{ route('noc.request_barang', ['status' => 'completed', 'search' => request('search'), 'month' => request('month'), 'year' => request('year')]) }}">Completed</a>
                                    </li>
                                </ul>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; vertical-align: middle;">
                                                    <a href="{{ route('noc.request_barang.show', $requestBarang->id) }}" class="btn btn-success btn-sm">
                                                        <i class="fa fa-eye"></i>
                                                    </a>

                                                    <a href="{{ route('noc.request_barang.edit', $requestBarang->id) }}" class="btn btn-info btn-sm">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                    <form id="delete-form-{{ $requestBarang->id }}" action="{{ route('noc.request_destroy', $requestBarang->id) }}" method="POST" style="display:inline-block;">
                                                        @csrf
                                                        @method('DELETE')
