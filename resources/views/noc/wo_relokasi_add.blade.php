                ...
                <div class="content-wrapper">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-6"> <!-- Lebar form setengah halaman -->
                            <div class="card">
                                <div class="card-body">
                                    <a href="{{ route('noc.relokasi.show', $getRelokasi->id) }}" class="btn btn-sm btn-info"> <i class="fa fa-arrow-left"></i></a>

                                    <h4 class="mb-5 text-center">Update Progress Relokasi</h4>
                                    {{-- Form untuk mengupload multiple foto --}}
                                    <form action="{{ route('noc_relokasi_add_progress', $getRelokasi->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
