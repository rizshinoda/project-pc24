            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <form action="{{ route('noc_relokasi_add_progress', $getRelokasi->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <a href="{{ route('noc.relokasi.show', $getRelokasi->id) }}" class="btn btn-info"><i class="fa fa-arrow-left"></i> Kembali</a>
                            ...
                            <button type="submit" name="action" value="complete" class="btn btn-success pull-right">Selesaikan Proses Relokasi</button>
                        </div>
                    </form>
                </div>
