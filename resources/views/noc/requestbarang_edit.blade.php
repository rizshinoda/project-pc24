                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('noc.request_barang.update', $requestBarang->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="nama_penerima" name="nama_penerima" value="{{ $requestBarang->nama_penerima }}" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" id="alamat_penerima" name="alamat_penerima" class="form-control" value="{{ $requestBarang->alamat_penerima }}" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" id="no_penerima" name="no_penerima" class="form-control" value="{{ $requestBarang->no_penerima }}" required>
                                                </div>
                                            </div>
                                            ...
                                            <a href="{{ route('noc.request_barang',) }}" class="btn btn-light">Kembali</a>
