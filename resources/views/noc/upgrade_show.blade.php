                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <!-- Tombol Approve -->
                                    <form action="{{ route('noc.upgrade.approve', $getUpgrade->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        <button type="button" class="btn btn-success" onclick="confirmApproval('{{ route('noc.upgrade.approve', $getUpgrade->id) }}')">
                                    ...
                                    <!-- Tombol Kembali -->
                                    <a href="{{ route('noc.upgrade') }}" class="btn btn-info mt-3">
