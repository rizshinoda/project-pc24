                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <!-- Tombol Approve -->
                                    <form action="{{ route('noc.downgrade.approve', $getDowngrade->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        <button type="button" class="btn btn-success" onclick="confirmApproval('{{ route('noc.downgrade.approve', $getDowngrade->id) }}')">
                                    ...
                                    <a href="{{ route('noc_downgrade_add_progress', $getDowngrade->id) }}" class="btn btn-info mb-3">
                                        Add Progress</a>
                                    ...
                                    <!-- Tombol Kembali -->
                                    <a href="{{ route('noc.downgrade') }}" class="btn btn-info mt-3">
