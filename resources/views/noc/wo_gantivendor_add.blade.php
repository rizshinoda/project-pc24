            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <form action="{{ route('noc_gantivendor_add_progress', $getGantivendor->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <a href="{{ route('noc.gantivendor.show', $getGantivendor->id) }}" class="btn btn-info"> <i class="fa fa-arrow-left"></i> Kembali</a>
                            ...
                            <button type="submit" name="action" value="complete" class="btn btn-success pull-right">Selesaikan Proses Ganti Vendor</button>
                        </div>
                    </form>
                </div>
