...
class WorkOrderDowngradeExport implements FromCollection, WithHeadings, WithMapping, WithColumnWidths, WithStyles
{
    ...
    public function map($workOrder): array
    {
        return [
            ...
            $workOrder->onlineBilling->alamat_pemasangan, // Alamat panjang dibuat wrap text
            ...
            $workOrder->bandwidth_baru . ' ' . $workOrder->satuan, // Gabungkan bandwidth & satuan
            $workOrder->status,
        ];
    }
