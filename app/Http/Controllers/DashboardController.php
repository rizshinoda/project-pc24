...
class DashboardController extends Controller
{
    ...
    public function editUser($id)
    {
        ...
        // Gabungkan data survey ke dalam data role
        $data = array_merge($this->ambilDataRole(), compact('userlist', 'notifications'));
